...
func (m *implMode2) Signer(sk PrivateKey) Signer {
	return mode2.NewSigner(sk.(*mode2.PrivateKey))
}

func (m *implMode2) Verifier(pk PublicKey) Verifier {
	return mode2.NewVerifier(pk.(*mode2.PublicKey))
}
