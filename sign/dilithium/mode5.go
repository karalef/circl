...
func (m *implMode5) Signer(sk PrivateKey) Signer {
	return mode5.NewSigner(sk.(*mode5.PrivateKey))
}

func (m *implMode5) Verifier(pk PublicKey) Verifier {
	return mode5.NewVerifier(pk.(*mode5.PublicKey))
}
